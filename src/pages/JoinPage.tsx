...
import { Users, Calendar, Map, Activity, Briefcase, Verified, Heart } from 'lucide-react';
              ...
              <div className="mb-8">
                <div className="flex items-start">
                  ...
                  <label htmlFor="terms" className="ml-2 block text-sm text-gray-700">
                    J'accepte les <a href="/privacy" className="text-teal-600 hover:text-teal-700">conditions d'utilisation</a> et la <a href="/terms" className="text-teal-600 hover:text-teal-700">politique de confidentialité</a> d'ASFO.
                  </label>
                </div>
              </div>
            ...
            {[
              ...
              <div key={index} className="bg-gray-50 rounded-lg overflow-hidden shadow-sm border border-gray-100">
                ...
                <div className="p-6">
                  ...
                  <p className="text-teal-600 text-sm mb-4">{testimonial.role}</p>
